...
const Tentang = () => {
  return (
    <>
      <NextSeo
        title={"Tentang Kami — Cahaya Abadi"}
        description={
          "Cahaya Abadi didirikan pada tahun 2009 dengan persewaan ambulance dan penjualan peti mati menjadi bisnis utama"
        }
        openGraph={{
          title: "Tentang Kami — Cahaya Abadi",
          description:
      ...
      <main className="max-w-6xl mx-auto my-16 lg:my-24 px-4 md:px-10 mb-20 min-h-[60vh]">
        <div className="text-center mx-auto my-8 lg:my-12 max-w-5xl">
          ...
          <p>
            Cahaya Abadi didirikan pada tahun 2009 dengan persewaan ambulance
            dan penjualan peti mati adalah bisnis utama kami, yang dikembangkan
            dengan menjunjung tinggi tanggung jawab kerja. <br />
            <br /> Kepuasan pelanggan adalah kebahagiaan kami. Kendaraan yang
            digunakan dalam kondisi siap pakai dengan perlengkapan sesuai
            standard pengaman untuk operasional dilapangan. Adapun
